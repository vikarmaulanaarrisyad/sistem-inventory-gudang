<x-modal data-backdrop="static" data-keyboard="false" size="modal-md">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label for="harga">Harga <span class="text-danger" style="font-size: 0.80em">Barang
                        *</span></label>
                <input id="harga" class="form-control form-control-border" type="text" name="harga"
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <input id="stock" class="form-control form-control-border" type="number" name="stock"
                    autocomplete="off" placeholder="Masukkan stok barang" min="0">
            </div>
        </div>
    </div>
